...
public class MedicamentoMapper {
    ...
    public static Medicamento toEntity(Medicamento dto){
        Medicamento entity = new Medicamento(dto.getNome(), dto.getTipo(), dto.getVencimento());
        return entity;
    }

    public static MedicamentoDTO toDTO(Medicamento entity){
        MedicamentoDTO dto = new MedicamentoDTO(entity.getNome(), entity.getTipo(), entity.getVencimento());
        return dto;
    }
